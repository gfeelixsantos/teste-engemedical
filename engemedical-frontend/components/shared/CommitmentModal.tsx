          ...
          <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2 flex flex-col gap-2">
                  <div className="flex items-center gap-2">
                    ...
                    <Button className="bg-brand-500 text-white font-semibold hover:bg-brand-600 transition-colors" onPress={handleAddParticipant} variant="solid">
                      Adicionar
                    </Button>
                  </div>
                ...
                <div className="md:col-span-2 flex flex-col gap-2">
                  <div className="flex items-center gap-2">
                    <Input 
                      ...
                      className="flex-1"
                    />
                <Button onPress={handleAddEmail} className="bg-brand-500 text-white font-semibold hover:bg-brand-600 transition-colors" variant="solid">
                      Adicionar
                    </Button>
                  </div>
                  <div className="flex flex-wrap gap-2 mt-2">
            ...
            <ModalFooter className="flex justify-between w-full">
              ...
              <div className="flex gap-2">
                ...
                <Button className="bg-brand-500 text-white font-semibold hover:bg-brand-600 transition-colors" onPress={() => {
