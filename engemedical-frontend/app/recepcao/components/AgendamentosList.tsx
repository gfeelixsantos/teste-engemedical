...
const DetalhesModal: React.FC<{
  ...
  return (
    <Modal
      ...
      classNames={{
        base: "max-h-[90vh] border border-[#28B1CF]/20",
        wrapper: "z-[1000]",
      }}
      isOpen={isOpen}
  ...
  return (
    <>
      <Button
        ...
        className="flex w-full items-center justify-center gap-2 py-2.5 rounded-xl font-medium bg-[#EFFBFD] text-[#28B1CF] border border-[#28B1CF]/30 hover:bg-[#C5EAF5] focus:ring-2 focus:ring-[#28B1CF]/20"
