    ...
    <aside className="w-full sm:w-82 lg:w-[26rem] bg-content1 flex-shrink-0 flex flex-col overflow-y-auto">
      ...
      >
        <ModalContent className="border border-brand-500/20">
          <ModalHeader className="bg-gradient-to-r from-brand-500 to-brand-700 text-white flex flex-col gap-1">
          ...
          <ModalBody className="py-6 flex flex-col items-center justify-center text-center">
            ...
            {pscAuthWindowUrl && (
              <div className="bg-brand-100 border border-brand-green-500 p-3 rounded-lg w-full mb-4">
                <p className="text-xs text-brand-700 mb-1 font-medium text-center">
                  A janela não abriu?
                </p>
                <a
                  className="text-brand-700 hover:text-brand-800 hover:underline text-xs break-all text-center block"
      ...
      >
        <ModalContent className="border border-brand-500/20">
          <ModalHeader className="flex flex-col gap-1 bg-gradient-to-r from-brand-500 to-brand-700 text-white">
            <div className="flex items-center gap-2">
          ...
          <ModalFooter className="px-6 pb-4">
            ...
            <Button
              className="font-medium bg-gradient-to-r from-brand-500 to-brand-700 text-white focus-visible:ring-2 focus-visible:ring-brand-500/40"
              onPress={() => {
