...
export function HeaderKpisAbsenteismo({ kpis, isLoading }: HeaderKpisProps) {
  ...
  if (isLoading) {
    return (
      <div className="h-20 bg-white rounded-xl border border-gray-100 animate-pulse shadow-md mb-6" />
    );
  }
    ...
    <div className="mb-6 flex justify-center">
      ...
      <div className="flex justify-center">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-6 justify-center gap-3">
          ...
          {/* Card 6 */}
          <div className="bg-white rounded-xl border border-gray-200 px-4 py-2.5 text-center shadow-md min-w-[130px]">
            <div className="text-xl font-extrabold text-teal-800 leading-none mb-1">
