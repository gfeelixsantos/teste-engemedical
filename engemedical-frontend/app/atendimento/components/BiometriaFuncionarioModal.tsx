    ...
    if (status === "SEM_CADASTRO_ATIVO") {
      return (
        <div className="flex flex-col items-center text-center py-4 gap-3">
          ...
          <Button
            color="success"
            className="w-full mt-4 font-bold text-white bg-[#28B1CF]"
                  ...
                  return (
                    <button
                      ...
                      className={[
                        ...
                        isSelected
                          ? "border-[#28B1CF] bg-[#28B1CF]/5"
                          : "border-gray-200 bg-white hover:border-[#28B1CF]/40",
                      ].join(" ")}
                    ...
                    >
                      <div className="flex items-center justify-between gap-3">
                        ...
                        <span className="rounded-full bg-[#28B1CF]/10 px-2.5 py-1 text-xs font-semibold text-[#28B1CF]">
