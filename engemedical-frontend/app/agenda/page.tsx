      ...
      <main className="mx-auto max-w-7xl p-4 sm:p-6 lg:p-8">
        <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button 
              className="bg-[#28B1CF] text-white font-semibold hover:bg-[#047A9E] hover:shadow-md transition-all duration-200 transform hover:scale-[1.02]"
              onPress={() => {
          ...
          >
            <div className="p-5 flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-xl flex items-center justify-center bg-[#28B1CF] text-white shadow-md">
              ...
              <span className="text-xs text-[#28B1CF] font-semibold select-none">
