...
export const QUEUE_WORKER_MAP: Record<string, QueueWorkerInfo> = {
  "resultados-exames": {
    ...
    consumer: "engemedical-connect-worker (PDF Worker)",
    concurrency: 3,
  ...
  email: {
    ...
    consumer: "engemedical-connect-worker (Email Worker)",
    concurrency: 5,
    visibilitySeconds: 600,
  ...
  "customer-email-campaign": {
    ...
    consumer: "engemedical-connect-worker (Campaign Orchestrator)",
    concurrency: 1,
  ...
  socged: {
    ...
    consumer: "Backend + engemedical-connect-worker",
    concurrency: 1,
    visibilitySeconds: 300,
  ...
  "aso-processing": {
    ...
    consumer: "engemedical-connect-aso-generate (Puppeteer)",
    concurrency: 1,
  ...
  "aso-enriquecimento": {
    ...
    consumer: "engemedical-connect-worker (Enrichment)",
    concurrency: 1,
    visibilitySeconds: 600,
  ...
  "ged-batch": {
    ...
    consumer: "engemedical-connect-worker (GED Batch)",
    concurrency: 1,
    visibilitySeconds: 600,
