...
export class CronJobs implements OnModuleInit {
  ...
  onModuleInit() {
    this.logger.log(
      'CronJobs inicializado: 00:01 (manutenção), 19:20 (teste SFTP+Inativação), 03:00 (GED), 22:00 dia 23 (inativação)',
    );
  }
  ...
  /**
   * [TESTE] Executa todo dia às 19:20 — SFTP Grupo Tora + Inativação em massa.
   ...
   */
  @Cron('20 19 * * *', { timeZone: 'America/Sao_Paulo' })
