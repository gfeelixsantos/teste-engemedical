/**
 * Saneamento de registros biométricos inválidos (JavaScript)
 *
 * Uso:
 *   node scripts/saneamento_biometria.js           # equivale a --dry-run
 *   node scripts/saneamento_biometria.js --dry-run  # lista afetados, NÃO altera
 *   node scripts/saneamento_biometria.js --apply    # aplica as alterações
 *
 * Este script:
...
async function main() {
  ...
  try {
    ...
    if (isDryRun) {
      ...
      console.log('   node scripts/saneamento_biometria.js --apply');
      console.log('');
      return;
    }
